...
\vspace{0.2cm}
\begin{itemize}
    \item \texttt{MultiPianoApp} owns \texttt{AudioEngine}, \texttt{NetworkManager}, and \texttt{NoteScheduler}.
...
\begin{frame}{Audio — Scheduled Playback}
...
\vspace{0.3cm}
\textbf{NoteScheduler} for remote notes:
\begin{itemize}
